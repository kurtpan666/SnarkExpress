  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 sm:bottom-4 sm:left-4 sm:right-auto bg-white dark:bg-gray-800 sm:bg-transparent sm:dark:bg-transparent border-t sm:border-t-0 border-gray-200 dark:border-gray-700 sm:border-none text-xs text-gray-600 dark:text-gray-400 z-10">
      <div className="flex flex-row sm:flex-col items-center sm:items-start justify-center sm:justify-start gap-2 sm:gap-0 p-2 sm:p-0">
        ...
        <div className="hidden sm:block">for the <a href="https://zkpunk.pro" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">ZKPunk</a></div>
